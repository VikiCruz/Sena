"""6. Cree un programa que lea una cantidad e imprima un porcentaje a calcular requerido sobre esa cantidad. Use
funciones. Haga pruebas de escritorio."""
#Pseudocodigo
...
if porcentaje > 100:
    ...
    print("el porcentaje no debe ser negativo")
