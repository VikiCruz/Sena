# Cree un programa que tome el valor de un producto e imprima su precio final si este tiene siempre un descuento del 10%. Use funciones. Haga pruebas de escritorio.
...
if valor_producto < 0:
    print("No se admite valores negativos")
    exit()
